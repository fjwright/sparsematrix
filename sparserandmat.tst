on errcont;
sparse_random_matrix(3);                % => square
sparse_random_matrix(3, 5);
sparse_random_matrix(3, 5, 10);         % error
sparse_random_matrix(3, 5, limit=10);
...
sparse_random_matrix(3, 5, symbol);
sparse_random_matrix(3, 5, limit=10, symbol); % error
...
sparse_random_matrix(5, limit=10, symmetric, invertible);
sparse_random_matrix(5, symbol, symmetric, invertible);
sparse_random_matrix(5, limit=10, anti_symmetric);
sparse_random_matrix(5, limit=10, anti_symmetric, invertible); % error
sparse_random_matrix(5, limit=10, hermitian);
sparse_random_matrix(5, limit=10, hermitian, invertible);
sparse_random_matrix(5, limit=10, anti_hermitian);
sparse_random_matrix(5, limit=10, anti_hermitian, invertible);
sparse_random_matrix(5, limit=10, foo); % error
;end;
