...
sparse_random_matrix(3, 5, 10, density = 100); % WRONG?
sparse_random_matrix(3, 5, 10, density = 1.0);
sparse_random_matrix(3, 5, 10, density = 0.5);
sparse_random_matrix(3, 5, 10, density = 1/2);
sparse_random_matrix(5, 5, 10, diagonal);      % ???
sparse_random_matrix(5, 5, 10, diagonal, density = 1.00); % ???
